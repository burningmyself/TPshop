...
class GoodsController extends MobileBaseController
{
    ...
    public function goodsInfo()
    {
        ...
        //会员优惠特权
        $levels=M('user_level') ->field('level_name,discount') ->select();
        $this->assign('levels',$levels);//会员特权
    ...
    public function ajaxComment()
    {
        ...
        $show = $page->show();
        $sql = "SELECT * FROM __PREFIX__comment c  JOIN __PREFIX__users as u ON c.user_id=u.user_id WHERE " . $where . " order by add_time desc" . "  limit " . $page->firstRow . "," . $page->listRows;
